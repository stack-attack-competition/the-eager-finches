...
<!--          <img class="android-logo-image" src="images/android-logo.png" alt="logo">-->
		...
		<div class="android-navigation-container">
			<nav class="android-navigation mdl-navigation">
				<a class="mdl-navigation__link mdl-typography--text-uppercase" href="/challenges">Register</a>
				<a class="mdl-navigation__link mdl-typography--text-uppercase" href="/challenges">Login</a>
			</nav>
		</div>
	</div>
</div>
