...
<div class="android-header mdl-layout__header mdl-layout__header--waterfall">
	<div aria-expanded={isOpen} role="button" tabindex="0" class="mdl-layout__drawer-button" on:click={() => menuToggle()}>
			...
			<nav class="android-navigation mdl-navigation">
				{#if !$isLoggedIn}
					<a class="mdl-navigation__link mdl-typography--text-uppercase"
					   href="/auth/registration">Register</a>
					<a class="mdl-navigation__link mdl-typography--text-uppercase" href="/auth/login">Login</a>
				{/if}
			</nav>
		</div>
	</div>
